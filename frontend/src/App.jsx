    ...
    >
      ...
      {currentModule === 'production' && (
        <>
          ...
          {['inventory-vendors','inventory-materials','inventory-stock','inventory-issue','inventory-receipt','inventory-movements','inventory-planning'].includes(productionView) && (
